        ...
        public string GenerateToken(TokenData data)
        {
            ...
            try
            {
                ...
                var claims = new List<Claim>
                {
                    ...
                    new("solicitante", !string.IsNullOrWhiteSpace(data.Solicitante) ? data.Solicitante : string.Empty),
                    new("nombres", !string.IsNullOrWhiteSpace(data.Nombres) ? data.Nombres : string.Empty),
                    new("apellidos", !string.IsNullOrWhiteSpace(data.Apellidos) ? data.Apellidos : string.Empty),
                    new("email", !string.IsNullOrWhiteSpace(data.Email) ? data.Email : string.Empty),
                    new("tokenOrigen", !string.IsNullOrWhiteSpace(data.TokenOrigen) ? data.TokenOrigen : string.Empty),
                };
