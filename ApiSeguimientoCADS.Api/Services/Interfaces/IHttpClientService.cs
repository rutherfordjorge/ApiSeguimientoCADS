...
namespace ApiSeguimientoCADS.Api.Services.Interfaces
{
    ...
    public interface IHttpClientService
    {
        ...
        /// <summary>
        /// Ejecuta una llamada POST con cuerpo JSON y encabezados personalizados.
        /// </summary>
        /// <param name="url">URL del endpoint.</param>
        /// <param name="jsonBody">Contenido JSON a enviar.</param>
        /// <param name="headers">Diccionario opcional de encabezados.</param>
        /// <returns>Respuesta como string.</returns>
        Task<string> PostAsync(Uri url, string jsonBody, Dictionary<string, string>? headers = null);
    }
}