...
namespace ApiSeguimientoCADS.Api.Services
{
    ...
    public partial class HttpClientService : IHttpClientService
    {
        ...
        public async Task<string> PostAsync(Uri url, string jsonBody, Dictionary<string, string>? headers = null)
        {
            this._http.DefaultRequestHeaders.Clear();
            this._http.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            ...
            var response = await this._http.PostAsync(url, content).ConfigureAwait(false);
